...
type Client struct {
	...
	ContainerDriver                         ContainerDriverOperations
	...
	BkeK8sSystemImage                       BkeK8sSystemImageOperations
	BkeK8sServiceOption                     BkeK8sServiceOptionOperations
	BkeAddon                                BkeAddonOperations
...
func NewClient(opts *clientbase.ClientOpts) (*Client, error) {
	...
	client.ContainerDriver = newContainerDriverClient(client)
	...
	client.BkeK8sSystemImage = newBkeK8sSystemImageClient(client)
	client.BkeK8sServiceOption = newBkeK8sServiceOptionClient(client)
	client.BkeAddon = newBkeAddonClient(client)
