...
type Config struct {
	...
	ContainerDrivers                         map[string]managementClient.ContainerDriver                         `json:"containerDrivers,omitempty" yaml:"containerDrivers,omitempty"`
	...
	BkeK8sSystemImages                       map[string]managementClient.BkeK8sSystemImage                       `json:"bkeK8sSystemImages,omitempty" yaml:"bkeK8sSystemImages,omitempty"`
	BkeK8sServiceOptions                     map[string]managementClient.BkeK8sServiceOption                     `json:"bkeK8sServiceOptions,omitempty" yaml:"bkeK8sServiceOptions,omitempty"`
	BkeAddons                                map[string]managementClient.BkeAddon                                `json:"bkeAddons,omitempty" yaml:"bkeAddons,omitempty"`
