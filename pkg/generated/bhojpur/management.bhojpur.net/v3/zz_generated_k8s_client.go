...
type Interface interface {
	...
	BkeK8sSystemImagesGetter
	BkeK8sServiceOptionsGetter
	BkeAddonsGetter
	CisConfigsGetter
...
type ContainerDriversGetter interface {
	ContainerDrivers(namespace string) ContainerDriverInterface
}

func (c *Client) ContainerDrivers(namespace string) ContainerDriverInterface {
	sharedClient := c.clientFactory.ForResourceKind(ContainerDriverGroupVersionResource, ContainerDriverGroupVersionKind.Kind, false)
	objectClient := objectclient.NewObjectClient(namespace, sharedClient, &ContainerDriverResource, ContainerDriverGroupVersionKind, containerDriverFactory{})
...
type BkeK8sSystemImagesGetter interface {
	BkeK8sSystemImages(namespace string) BkeK8sSystemImageInterface
}

func (c *Client) BkeK8sSystemImages(namespace string) BkeK8sSystemImageInterface {
	sharedClient := c.clientFactory.ForResourceKind(BkeK8sSystemImageGroupVersionResource, BkeK8sSystemImageGroupVersionKind.Kind, true)
	objectClient := objectclient.NewObjectClient(namespace, sharedClient, &BkeK8sSystemImageResource, BkeK8sSystemImageGroupVersionKind, bkeK8sSystemImageFactory{})
...
type BkeK8sServiceOptionsGetter interface {
	BkeK8sServiceOptions(namespace string) BkeK8sServiceOptionInterface
}

func (c *Client) BkeK8sServiceOptions(namespace string) BkeK8sServiceOptionInterface {
	sharedClient := c.clientFactory.ForResourceKind(BkeK8sServiceOptionGroupVersionResource, BkeK8sServiceOptionGroupVersionKind.Kind, true)
	objectClient := objectclient.NewObjectClient(namespace, sharedClient, &BkeK8sServiceOptionResource, BkeK8sServiceOptionGroupVersionKind, bkeK8sServiceOptionFactory{})
...
type BkeAddonsGetter interface {
	BkeAddons(namespace string) BkeAddonInterface
}

func (c *Client) BkeAddons(namespace string) BkeAddonInterface {
	sharedClient := c.clientFactory.ForResourceKind(BkeAddonGroupVersionResource, BkeAddonGroupVersionKind.Kind, true)
	objectClient := objectclient.NewObjectClient(namespace, sharedClient, &BkeAddonResource, BkeAddonGroupVersionKind, bkeAddonFactory{})
