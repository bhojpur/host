...
// Deprecated use v3.Node instead
type Node = v3.Node

func NewNode(namespace, name string, obj v3.Node) *v3.Node {
...
type NodeChangeHandlerFunc func(obj *v3.Node) (runtime.Object, error)

type NodeLister interface {
	List(namespace string, selector labels.Selector) (ret []*v3.Node, err error)
...
type NodeInterface interface {
	...
	List(opts metav1.ListOptions) (*v3.NodeList, error)
	ListNamespaced(namespace string, opts metav1.ListOptions) (*v3.NodeList, error)
...
func (l *nodeLister) List(namespace string, selector labels.Selector) (ret []*v3.Node, err error) {
	if namespace == "" {
		namespace = l.ns
	}
	err = cache.ListAllByNamespace(l.controller.Informer().GetIndexer(), namespace, selector, func(obj interface{}) {
		ret = append(ret, obj.(*v3.Node))
	})
	return
}

func (l *nodeLister) Get(namespace, name string) (*v3.Node, error) {
	var key string
	if namespace != "" {
		key = namespace + "/" + name
	} else {
...
func (c *nodeController) AddClusterScopedHandler(ctx context.Context, name, cluster string, handler NodeHandlerFunc) {
	c.GenericController.AddHandler(ctx, name, func(key string, obj interface{}) (interface{}, error) {
		if obj == nil {
			return handler(key, nil)
		} else if v, ok := obj.(*v3.Node); ok && controller.ObjectInCluster(cluster, obj) {
			return handler(key, v)
		} else {
			return nil, nil
		}
...
func (s *nodeClient) Create(o *v3.Node) (*v3.Node, error) {
	obj, err := s.objectClient.Create(o)
	return obj.(*v3.Node), err
}

func (s *nodeClient) Get(name string, opts metav1.GetOptions) (*v3.Node, error) {
	obj, err := s.objectClient.Get(name, opts)
	return obj.(*v3.Node), err
}

func (s *nodeClient) GetNamespaced(namespace, name string, opts metav1.GetOptions) (*v3.Node, error) {
	obj, err := s.objectClient.GetNamespaced(namespace, name, opts)
	return obj.(*v3.Node), err
}

func (s *nodeClient) Update(o *v3.Node) (*v3.Node, error) {
	obj, err := s.objectClient.Update(o.Name, o)
	return obj.(*v3.Node), err
}

func (s *nodeClient) UpdateStatus(o *v3.Node) (*v3.Node, error) {
...
func (s *nodeClient) List(opts metav1.ListOptions) (*v3.NodeList, error) {
	obj, err := s.objectClient.List(opts)
	return obj.(*v3.NodeList), err
}

func (s *nodeClient) ListNamespaced(namespace string, opts metav1.ListOptions) (*v3.NodeList, error) {
...
func (s *nodeClient) Patch(o *v3.Node, patchType types.PatchType, data []byte, subresources ...string) (*v3.Node, error) {
