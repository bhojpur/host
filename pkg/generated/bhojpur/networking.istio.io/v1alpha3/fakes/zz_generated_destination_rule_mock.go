...
// Ensure, that DestinationRuleListerMock does implement networkingistioiov1alpha3.DestinationRuleLister.
// If this is not the case, regenerate this file with moq.
var _ networkingistioiov1alpha3.DestinationRuleLister = &DestinationRuleListerMock{}

// DestinationRuleListerMock is a mock implementation of networkingistioiov1alpha3.DestinationRuleLister.
//
// 	func TestSomethingThatUsesDestinationRuleLister(t *testing.T) {
//
// 		// make and configure a mocked networkingistioiov1alpha3.DestinationRuleLister
// 		mockedDestinationRuleLister := &DestinationRuleListerMock{
// 			GetFunc: func(namespace string, name string) (*istiov1alpha3.DestinationRule, error) {
// 				panic("mock out the Get method")
// 			},
// 			ListFunc: func(namespace string, selector labels.Selector) ([]*istiov1alpha3.DestinationRule, error) {
// 				panic("mock out the List method")
// 			},
// 		}
//
// 		// use mockedDestinationRuleLister in code that requires networkingistioiov1alpha3.DestinationRuleLister
...
// Get calls GetFunc.
func (mock *DestinationRuleListerMock) Get(namespace string, name string) (*istiov1alpha3.DestinationRule, error) {
	if mock.GetFunc == nil {
...
// List calls ListFunc.
func (mock *DestinationRuleListerMock) List(namespace string, selector labels.Selector) ([]*istiov1alpha3.DestinationRule, error) {
...
// Ensure, that DestinationRuleControllerMock does implement networkingistioiov1alpha3.DestinationRuleController.
// If this is not the case, regenerate this file with moq.
var _ networkingistioiov1alpha3.DestinationRuleController = &DestinationRuleControllerMock{}

// DestinationRuleControllerMock is a mock implementation of networkingistioiov1alpha3.DestinationRuleController.
//
// 	func TestSomethingThatUsesDestinationRuleController(t *testing.T) {
//
// 		// make and configure a mocked networkingistioiov1alpha3.DestinationRuleController
// 		mockedDestinationRuleController := &DestinationRuleControllerMock{
// 			AddClusterScopedFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, clusterName string, handler networkingistioiov1alpha3.DestinationRuleHandlerFunc)  {
// 				panic("mock out the AddClusterScopedFeatureHandler method")
// 			},
// 			AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, handler networkingistioiov1alpha3.DestinationRuleHandlerFunc)  {
// 				panic("mock out the AddClusterScopedHandler method")
// 			},
// 			AddFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, syncMoqParam networkingistioiov1alpha3.DestinationRuleHandlerFunc)  {
// 				panic("mock out the AddFeatureHandler method")
// 			},
// 			AddHandlerFunc: func(ctx context.Context, name string, handler networkingistioiov1alpha3.DestinationRuleHandlerFunc)  {
...
// 			},
// 			ListerFunc: func() networkingistioiov1alpha3.DestinationRuleLister {
// 				panic("mock out the Lister method")
// 			},
// 		}
//
// 		// use mockedDestinationRuleController in code that requires networkingistioiov1alpha3.DestinationRuleController
// 		// and then make assertions.
//
// 	}
type DestinationRuleControllerMock struct {
	...
	calls struct {
		...
		AddClusterScopedFeatureHandler []struct {
			...
			Handler networkingistioiov1alpha3.DestinationRuleHandlerFunc
		}
		...
		AddFeatureHandler []struct {
			...
			SyncMoqParam networkingistioiov1alpha3.DestinationRuleHandlerFunc
		}
...
func (mock *DestinationRuleControllerMock) AddClusterScopedFeatureHandler(ctx context.Context, enabled func() bool, name string, clusterName string, handler networkingistioiov1alpha3.DestinationRuleHandlerFunc) {
...
func (mock *DestinationRuleControllerMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, handler networkingistioiov1alpha3.DestinationRuleHandlerFunc) {
...
func (mock *DestinationRuleControllerMock) AddFeatureHandler(ctx context.Context, enabled func() bool, name string, syncMoqParam networkingistioiov1alpha3.DestinationRuleHandlerFunc) {
...
func (mock *DestinationRuleControllerMock) AddHandler(ctx context.Context, name string, handler networkingistioiov1alpha3.DestinationRuleHandlerFunc) {
...
func (mock *DestinationRuleControllerMock) Lister() networkingistioiov1alpha3.DestinationRuleLister {
...
// Ensure, that DestinationRuleInterfaceMock does implement networkingistioiov1alpha3.DestinationRuleInterface.
// If this is not the case, regenerate this file with moq.
var _ networkingistioiov1alpha3.DestinationRuleInterface = &DestinationRuleInterfaceMock{}

// DestinationRuleInterfaceMock is a mock implementation of networkingistioiov1alpha3.DestinationRuleInterface.
//
// 	func TestSomethingThatUsesDestinationRuleInterface(t *testing.T) {
//
// 		// make and configure a mocked networkingistioiov1alpha3.DestinationRuleInterface
// 		mockedDestinationRuleInterface := &DestinationRuleInterfaceMock{
// 			AddClusterScopedFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, clusterName string, syncMoqParam networkingistioiov1alpha3.DestinationRuleHandlerFunc)  {
// 				panic("mock out the AddClusterScopedFeatureHandler method")
// 			},
// 			AddClusterScopedFeatureLifecycleFunc: func(ctx context.Context, enabled func() bool, name string, clusterName string, lifecycle networkingistioiov1alpha3.DestinationRuleLifecycle)  {
// 				panic("mock out the AddClusterScopedFeatureLifecycle method")
// 			},
// 			AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, syncMoqParam networkingistioiov1alpha3.DestinationRuleHandlerFunc)  {
// 				panic("mock out the AddClusterScopedHandler method")
// 			},
// 			AddClusterScopedLifecycleFunc: func(ctx context.Context, name string, clusterName string, lifecycle networkingistioiov1alpha3.DestinationRuleLifecycle)  {
// 				panic("mock out the AddClusterScopedLifecycle method")
// 			},
// 			AddFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, syncMoqParam networkingistioiov1alpha3.DestinationRuleHandlerFunc)  {
// 				panic("mock out the AddFeatureHandler method")
// 			},
// 			AddFeatureLifecycleFunc: func(ctx context.Context, enabled func() bool, name string, lifecycle networkingistioiov1alpha3.DestinationRuleLifecycle)  {
// 				panic("mock out the AddFeatureLifecycle method")
// 			},
// 			AddHandlerFunc: func(ctx context.Context, name string, syncMoqParam networkingistioiov1alpha3.DestinationRuleHandlerFunc)  {
// 				panic("mock out the AddHandler method")
// 			},
// 			AddLifecycleFunc: func(ctx context.Context, name string, lifecycle networkingistioiov1alpha3.DestinationRuleLifecycle)  {
// 				panic("mock out the AddLifecycle method")
// 			},
// 			ControllerFunc: func() networkingistioiov1alpha3.DestinationRuleController {
// 				panic("mock out the Controller method")
// 			},
// 			CreateFunc: func(destinationRule *istiov1alpha3.DestinationRule) (*istiov1alpha3.DestinationRule, error) {
...
// 			},
// 			GetFunc: func(name string, opts metav1.GetOptions) (*istiov1alpha3.DestinationRule, error) {
// 				panic("mock out the Get method")
// 			},
// 			GetNamespacedFunc: func(namespace string, name string, opts metav1.GetOptions) (*istiov1alpha3.DestinationRule, error) {
// 				panic("mock out the GetNamespaced method")
// 			},
// 			ListFunc: func(opts metav1.ListOptions) (*istiov1alpha3.DestinationRuleList, error) {
// 				panic("mock out the List method")
// 			},
// 			ListNamespacedFunc: func(namespace string, opts metav1.ListOptions) (*istiov1alpha3.DestinationRuleList, error) {
// 				panic("mock out the ListNamespaced method")
// 			},
// 			ObjectClientFunc: func() *objectclient.ObjectClient {
// 				panic("mock out the ObjectClient method")
// 			},
// 			UpdateFunc: func(destinationRule *istiov1alpha3.DestinationRule) (*istiov1alpha3.DestinationRule, error) {
...
// 		}
//
// 		// use mockedDestinationRuleInterface in code that requires networkingistioiov1alpha3.DestinationRuleInterface
// 		// and then make assertions.
//
// 	}
type DestinationRuleInterfaceMock struct {
	...
	calls struct {
		...
		AddClusterScopedFeatureLifecycle []struct {
			...
			Lifecycle networkingistioiov1alpha3.DestinationRuleLifecycle
		}
		// AddClusterScopedHandler holds details about calls to the AddClusterScopedHandler method.
		AddClusterScopedHandler []struct {
			// Ctx is the ctx argument value.
		...
		Create []struct {
			// DestinationRule is the destinationRule argument value.
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *DestinationRuleInterfaceMock) AddClusterScopedFeatureHandler(ctx context.Context, enabled func() bool, name string, clusterName string, syncMoqParam networkingistioiov1alpha3.DestinationRuleHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *DestinationRuleInterfaceMock) AddClusterScopedFeatureLifecycle(ctx context.Context, enabled func() bool, name string, clusterName string, lifecycle networkingistioiov1alpha3.DestinationRuleLifecycle) {
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *DestinationRuleInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, syncMoqParam networkingistioiov1alpha3.DestinationRuleHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
func (mock *DestinationRuleInterfaceMock) AddClusterScopedLifecycle(ctx context.Context, name string, clusterName string, lifecycle networkingistioiov1alpha3.DestinationRuleLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *DestinationRuleInterfaceMock) AddFeatureHandler(ctx context.Context, enabled func() bool, name string, syncMoqParam networkingistioiov1alpha3.DestinationRuleHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *DestinationRuleInterfaceMock) AddFeatureLifecycle(ctx context.Context, enabled func() bool, name string, lifecycle networkingistioiov1alpha3.DestinationRuleLifecycle) {
...
// AddHandler calls AddHandlerFunc.
func (mock *DestinationRuleInterfaceMock) AddHandler(ctx context.Context, name string, syncMoqParam networkingistioiov1alpha3.DestinationRuleHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *DestinationRuleInterfaceMock) AddLifecycle(ctx context.Context, name string, lifecycle networkingistioiov1alpha3.DestinationRuleLifecycle) {
...
func (mock *DestinationRuleInterfaceMock) Controller() networkingistioiov1alpha3.DestinationRuleController {
...
func (mock *DestinationRuleInterfaceMock) Create(destinationRule *istiov1alpha3.DestinationRule) (*istiov1alpha3.DestinationRule, error) {
	...
	return mock.CreateFunc(destinationRule)
}
...
// Get calls GetFunc.
func (mock *DestinationRuleInterfaceMock) Get(name string, opts metav1.GetOptions) (*istiov1alpha3.DestinationRule, error) {
	if mock.GetFunc == nil {
...
func (mock *DestinationRuleInterfaceMock) GetNamespaced(namespace string, name string, opts metav1.GetOptions) (*istiov1alpha3.DestinationRule, error) {
...
// List calls ListFunc.
func (mock *DestinationRuleInterfaceMock) List(opts metav1.ListOptions) (*istiov1alpha3.DestinationRuleList, error) {
	if mock.ListFunc == nil {
...
func (mock *DestinationRuleInterfaceMock) ListNamespaced(namespace string, opts metav1.ListOptions) (*istiov1alpha3.DestinationRuleList, error) {
...
func (mock *DestinationRuleInterfaceMock) Update(destinationRule *istiov1alpha3.DestinationRule) (*istiov1alpha3.DestinationRule, error) {
	...
	return mock.UpdateFunc(destinationRule)
}
...
// Ensure, that DestinationRulesGetterMock does implement networkingistioiov1alpha3.DestinationRulesGetter.
// If this is not the case, regenerate this file with moq.
var _ networkingistioiov1alpha3.DestinationRulesGetter = &DestinationRulesGetterMock{}

// DestinationRulesGetterMock is a mock implementation of networkingistioiov1alpha3.DestinationRulesGetter.
//
// 	func TestSomethingThatUsesDestinationRulesGetter(t *testing.T) {
//
// 		// make and configure a mocked networkingistioiov1alpha3.DestinationRulesGetter
// 		mockedDestinationRulesGetter := &DestinationRulesGetterMock{
// 			DestinationRulesFunc: func(namespace string) networkingistioiov1alpha3.DestinationRuleInterface {
// 				panic("mock out the DestinationRules method")
// 			},
// 		}
//
// 		// use mockedDestinationRulesGetter in code that requires networkingistioiov1alpha3.DestinationRulesGetter
// 		// and then make assertions.
//
// 	}
type DestinationRulesGetterMock struct {
	...
	lockDestinationRules sync.RWMutex
}

// DestinationRules calls DestinationRulesFunc.
func (mock *DestinationRulesGetterMock) DestinationRules(namespace string) networkingistioiov1alpha3.DestinationRuleInterface {
...
func (mock *DestinationRulesGetterMock) DestinationRulesCalls() []struct {
	...
	mock.lockDestinationRules.RLock()
	calls = mock.calls.DestinationRules
	mock.lockDestinationRules.RUnlock()
	return calls
}
