...
// Ensure, that ClusterRoleBindingListerMock does implement rbacauthorizationk8siov1.ClusterRoleBindingLister.
// If this is not the case, regenerate this file with moq.
var _ rbacauthorizationk8siov1.ClusterRoleBindingLister = &ClusterRoleBindingListerMock{}

// ClusterRoleBindingListerMock is a mock implementation of rbacauthorizationk8siov1.ClusterRoleBindingLister.
//
// 	func TestSomethingThatUsesClusterRoleBindingLister(t *testing.T) {
//
// 		// make and configure a mocked rbacauthorizationk8siov1.ClusterRoleBindingLister
// 		mockedClusterRoleBindingLister := &ClusterRoleBindingListerMock{
// 			GetFunc: func(namespace string, name string) (*rbacv1.ClusterRoleBinding, error) {
...
// 		}
//
// 		// use mockedClusterRoleBindingLister in code that requires rbacauthorizationk8siov1.ClusterRoleBindingLister
...
// Get calls GetFunc.
func (mock *ClusterRoleBindingListerMock) Get(namespace string, name string) (*rbacv1.ClusterRoleBinding, error) {
	if mock.GetFunc == nil {
...
// List calls ListFunc.
func (mock *ClusterRoleBindingListerMock) List(namespace string, selector labels.Selector) ([]*rbacv1.ClusterRoleBinding, error) {
...
// Ensure, that ClusterRoleBindingControllerMock does implement rbacauthorizationk8siov1.ClusterRoleBindingController.
// If this is not the case, regenerate this file with moq.
var _ rbacauthorizationk8siov1.ClusterRoleBindingController = &ClusterRoleBindingControllerMock{}

// ClusterRoleBindingControllerMock is a mock implementation of rbacauthorizationk8siov1.ClusterRoleBindingController.
//
// 	func TestSomethingThatUsesClusterRoleBindingController(t *testing.T) {
//
// 		// make and configure a mocked rbacauthorizationk8siov1.ClusterRoleBindingController
// 		mockedClusterRoleBindingController := &ClusterRoleBindingControllerMock{
// 			AddClusterScopedFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, clusterName string, handler rbacauthorizationk8siov1.ClusterRoleBindingHandlerFunc)  {
// 				panic("mock out the AddClusterScopedFeatureHandler method")
// 			},
// 			AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, handler rbacauthorizationk8siov1.ClusterRoleBindingHandlerFunc)  {
// 				panic("mock out the AddClusterScopedHandler method")
// 			},
// 			AddFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, sync rbacauthorizationk8siov1.ClusterRoleBindingHandlerFunc)  {
// 				panic("mock out the AddFeatureHandler method")
// 			},
// 			AddHandlerFunc: func(ctx context.Context, name string, handler rbacauthorizationk8siov1.ClusterRoleBindingHandlerFunc)  {
...
// 			},
// 			ListerFunc: func() rbacauthorizationk8siov1.ClusterRoleBindingLister {
// 				panic("mock out the Lister method")
// 			},
// 		}
//
// 		// use mockedClusterRoleBindingController in code that requires rbacauthorizationk8siov1.ClusterRoleBindingController
// 		// and then make assertions.
//
// 	}
type ClusterRoleBindingControllerMock struct {
	...
	calls struct {
		...
		AddClusterScopedFeatureHandler []struct {
			...
			Handler rbacauthorizationk8siov1.ClusterRoleBindingHandlerFunc
		}
		...
		AddFeatureHandler []struct {
			...
			Sync rbacauthorizationk8siov1.ClusterRoleBindingHandlerFunc
		}
...
func (mock *ClusterRoleBindingControllerMock) AddClusterScopedFeatureHandler(ctx context.Context, enabled func() bool, name string, clusterName string, handler rbacauthorizationk8siov1.ClusterRoleBindingHandlerFunc) {
...
func (mock *ClusterRoleBindingControllerMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, handler rbacauthorizationk8siov1.ClusterRoleBindingHandlerFunc) {
...
func (mock *ClusterRoleBindingControllerMock) AddFeatureHandler(ctx context.Context, enabled func() bool, name string, sync rbacauthorizationk8siov1.ClusterRoleBindingHandlerFunc) {
...
func (mock *ClusterRoleBindingControllerMock) AddHandler(ctx context.Context, name string, handler rbacauthorizationk8siov1.ClusterRoleBindingHandlerFunc) {
...
func (mock *ClusterRoleBindingControllerMock) Lister() rbacauthorizationk8siov1.ClusterRoleBindingLister {
...
// Ensure, that ClusterRoleBindingInterfaceMock does implement rbacauthorizationk8siov1.ClusterRoleBindingInterface.
// If this is not the case, regenerate this file with moq.
var _ rbacauthorizationk8siov1.ClusterRoleBindingInterface = &ClusterRoleBindingInterfaceMock{}

// ClusterRoleBindingInterfaceMock is a mock implementation of rbacauthorizationk8siov1.ClusterRoleBindingInterface.
//
// 	func TestSomethingThatUsesClusterRoleBindingInterface(t *testing.T) {
//
// 		// make and configure a mocked rbacauthorizationk8siov1.ClusterRoleBindingInterface
// 		mockedClusterRoleBindingInterface := &ClusterRoleBindingInterfaceMock{
// 			AddClusterScopedFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, clusterName string, sync rbacauthorizationk8siov1.ClusterRoleBindingHandlerFunc)  {
// 				panic("mock out the AddClusterScopedFeatureHandler method")
// 			},
// 			AddClusterScopedFeatureLifecycleFunc: func(ctx context.Context, enabled func() bool, name string, clusterName string, lifecycle rbacauthorizationk8siov1.ClusterRoleBindingLifecycle)  {
// 				panic("mock out the AddClusterScopedFeatureLifecycle method")
// 			},
// 			AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, sync rbacauthorizationk8siov1.ClusterRoleBindingHandlerFunc)  {
// 				panic("mock out the AddClusterScopedHandler method")
// 			},
// 			AddClusterScopedLifecycleFunc: func(ctx context.Context, name string, clusterName string, lifecycle rbacauthorizationk8siov1.ClusterRoleBindingLifecycle)  {
// 				panic("mock out the AddClusterScopedLifecycle method")
// 			},
// 			AddFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, sync rbacauthorizationk8siov1.ClusterRoleBindingHandlerFunc)  {
// 				panic("mock out the AddFeatureHandler method")
// 			},
// 			AddFeatureLifecycleFunc: func(ctx context.Context, enabled func() bool, name string, lifecycle rbacauthorizationk8siov1.ClusterRoleBindingLifecycle)  {
// 				panic("mock out the AddFeatureLifecycle method")
// 			},
// 			AddHandlerFunc: func(ctx context.Context, name string, sync rbacauthorizationk8siov1.ClusterRoleBindingHandlerFunc)  {
// 				panic("mock out the AddHandler method")
// 			},
// 			AddLifecycleFunc: func(ctx context.Context, name string, lifecycle rbacauthorizationk8siov1.ClusterRoleBindingLifecycle)  {
// 				panic("mock out the AddLifecycle method")
// 			},
// 			ControllerFunc: func() rbacauthorizationk8siov1.ClusterRoleBindingController {
// 				panic("mock out the Controller method")
// 			},
// 			CreateFunc: func(clusterRoleBinding *rbacv1.ClusterRoleBinding) (*rbacv1.ClusterRoleBinding, error) {
...
// 			},
// 			GetFunc: func(name string, opts metav1.GetOptions) (*rbacv1.ClusterRoleBinding, error) {
// 				panic("mock out the Get method")
// 			},
// 			GetNamespacedFunc: func(namespace string, name string, opts metav1.GetOptions) (*rbacv1.ClusterRoleBinding, error) {
// 				panic("mock out the GetNamespaced method")
// 			},
// 			ListFunc: func(opts metav1.ListOptions) (*rbacv1.ClusterRoleBindingList, error) {
// 				panic("mock out the List method")
// 			},
// 			ListNamespacedFunc: func(namespace string, opts metav1.ListOptions) (*rbacv1.ClusterRoleBindingList, error) {
// 				panic("mock out the ListNamespaced method")
// 			},
// 			ObjectClientFunc: func() *objectclient.ObjectClient {
// 				panic("mock out the ObjectClient method")
// 			},
// 			UpdateFunc: func(clusterRoleBinding *rbacv1.ClusterRoleBinding) (*rbacv1.ClusterRoleBinding, error) {
...
// 		}
//
// 		// use mockedClusterRoleBindingInterface in code that requires rbacauthorizationk8siov1.ClusterRoleBindingInterface
// 		// and then make assertions.
//
// 	}
type ClusterRoleBindingInterfaceMock struct {
	...
	calls struct {
		...
		AddClusterScopedFeatureLifecycle []struct {
			...
			Lifecycle rbacauthorizationk8siov1.ClusterRoleBindingLifecycle
		}
		// AddClusterScopedHandler holds details about calls to the AddClusterScopedHandler method.
		AddClusterScopedHandler []struct {
			// Ctx is the ctx argument value.
		...
		Create []struct {
			// ClusterRoleBinding is the clusterRoleBinding argument value.
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *ClusterRoleBindingInterfaceMock) AddClusterScopedFeatureHandler(ctx context.Context, enabled func() bool, name string, clusterName string, sync rbacauthorizationk8siov1.ClusterRoleBindingHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *ClusterRoleBindingInterfaceMock) AddClusterScopedFeatureLifecycle(ctx context.Context, enabled func() bool, name string, clusterName string, lifecycle rbacauthorizationk8siov1.ClusterRoleBindingLifecycle) {
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *ClusterRoleBindingInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, sync rbacauthorizationk8siov1.ClusterRoleBindingHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
func (mock *ClusterRoleBindingInterfaceMock) AddClusterScopedLifecycle(ctx context.Context, name string, clusterName string, lifecycle rbacauthorizationk8siov1.ClusterRoleBindingLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *ClusterRoleBindingInterfaceMock) AddFeatureHandler(ctx context.Context, enabled func() bool, name string, sync rbacauthorizationk8siov1.ClusterRoleBindingHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *ClusterRoleBindingInterfaceMock) AddFeatureLifecycle(ctx context.Context, enabled func() bool, name string, lifecycle rbacauthorizationk8siov1.ClusterRoleBindingLifecycle) {
...
// AddHandler calls AddHandlerFunc.
func (mock *ClusterRoleBindingInterfaceMock) AddHandler(ctx context.Context, name string, sync rbacauthorizationk8siov1.ClusterRoleBindingHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *ClusterRoleBindingInterfaceMock) AddLifecycle(ctx context.Context, name string, lifecycle rbacauthorizationk8siov1.ClusterRoleBindingLifecycle) {
...
func (mock *ClusterRoleBindingInterfaceMock) Controller() rbacauthorizationk8siov1.ClusterRoleBindingController {
...
func (mock *ClusterRoleBindingInterfaceMock) Create(clusterRoleBinding *rbacv1.ClusterRoleBinding) (*rbacv1.ClusterRoleBinding, error) {
	...
	return mock.CreateFunc(clusterRoleBinding)
}
...
// Get calls GetFunc.
func (mock *ClusterRoleBindingInterfaceMock) Get(name string, opts metav1.GetOptions) (*rbacv1.ClusterRoleBinding, error) {
	if mock.GetFunc == nil {
...
func (mock *ClusterRoleBindingInterfaceMock) GetNamespaced(namespace string, name string, opts metav1.GetOptions) (*rbacv1.ClusterRoleBinding, error) {
...
// List calls ListFunc.
func (mock *ClusterRoleBindingInterfaceMock) List(opts metav1.ListOptions) (*rbacv1.ClusterRoleBindingList, error) {
	if mock.ListFunc == nil {
...
func (mock *ClusterRoleBindingInterfaceMock) ListNamespaced(namespace string, opts metav1.ListOptions) (*rbacv1.ClusterRoleBindingList, error) {
...
func (mock *ClusterRoleBindingInterfaceMock) Update(clusterRoleBinding *rbacv1.ClusterRoleBinding) (*rbacv1.ClusterRoleBinding, error) {
	...
	return mock.UpdateFunc(clusterRoleBinding)
}
...
// Ensure, that ClusterRoleBindingsGetterMock does implement rbacauthorizationk8siov1.ClusterRoleBindingsGetter.
// If this is not the case, regenerate this file with moq.
var _ rbacauthorizationk8siov1.ClusterRoleBindingsGetter = &ClusterRoleBindingsGetterMock{}

// ClusterRoleBindingsGetterMock is a mock implementation of rbacauthorizationk8siov1.ClusterRoleBindingsGetter.
//
// 	func TestSomethingThatUsesClusterRoleBindingsGetter(t *testing.T) {
//
// 		// make and configure a mocked rbacauthorizationk8siov1.ClusterRoleBindingsGetter
// 		mockedClusterRoleBindingsGetter := &ClusterRoleBindingsGetterMock{
// 			ClusterRoleBindingsFunc: func(namespace string) rbacauthorizationk8siov1.ClusterRoleBindingInterface {
// 				panic("mock out the ClusterRoleBindings method")
// 			},
// 		}
//
// 		// use mockedClusterRoleBindingsGetter in code that requires rbacauthorizationk8siov1.ClusterRoleBindingsGetter
// 		// and then make assertions.
//
// 	}
type ClusterRoleBindingsGetterMock struct {
	...
	lockClusterRoleBindings sync.RWMutex
}

// ClusterRoleBindings calls ClusterRoleBindingsFunc.
func (mock *ClusterRoleBindingsGetterMock) ClusterRoleBindings(namespace string) rbacauthorizationk8siov1.ClusterRoleBindingInterface {
...
func (mock *ClusterRoleBindingsGetterMock) ClusterRoleBindingsCalls() []struct {
	...
	mock.lockClusterRoleBindings.RLock()
	calls = mock.calls.ClusterRoleBindings
	mock.lockClusterRoleBindings.RUnlock()
	return calls
}
