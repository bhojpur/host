...
// Ensure, that SecretListerMock does implement bhojpurcorev1.SecretLister.
// If this is not the case, regenerate this file with moq.
var _ bhojpurcorev1.SecretLister = &SecretListerMock{}

// SecretListerMock is a mock implementation of bhojpurcorev1.SecretLister.
//
// 	func TestSomethingThatUsesSecretLister(t *testing.T) {
//
// 		// make and configure a mocked bhojpurcorev1.SecretLister
...
// 		}
//
// 		// use mockedSecretLister in code that requires bhojpurcorev1.SecretLister
...
// Ensure, that SecretControllerMock does implement bhojpurcorev1.SecretController.
// If this is not the case, regenerate this file with moq.
var _ bhojpurcorev1.SecretController = &SecretControllerMock{}

// SecretControllerMock is a mock implementation of bhojpurcorev1.SecretController.
//
// 	func TestSomethingThatUsesSecretController(t *testing.T) {
//
// 		// make and configure a mocked bhojpurcorev1.SecretController
// 		mockedSecretController := &SecretControllerMock{
// 			AddClusterScopedFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, clusterName string, handler bhojpurcorev1.SecretHandlerFunc)  {
// 				panic("mock out the AddClusterScopedFeatureHandler method")
// 			},
// 			AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, handler bhojpurcorev1.SecretHandlerFunc)  {
// 				panic("mock out the AddClusterScopedHandler method")
// 			},
// 			AddFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, syncMoqParam bhojpurcorev1.SecretHandlerFunc)  {
// 				panic("mock out the AddFeatureHandler method")
// 			},
// 			AddHandlerFunc: func(ctx context.Context, name string, handler bhojpurcorev1.SecretHandlerFunc)  {
...
// 			},
// 			ListerFunc: func() bhojpurcorev1.SecretLister {
// 				panic("mock out the Lister method")
// 			},
// 		}
//
// 		// use mockedSecretController in code that requires bhojpurcorev1.SecretController
// 		// and then make assertions.
//
// 	}
type SecretControllerMock struct {
	...
	calls struct {
		...
		AddClusterScopedFeatureHandler []struct {
			...
			Handler bhojpurcorev1.SecretHandlerFunc
		}
		...
		AddFeatureHandler []struct {
			...
			SyncMoqParam bhojpurcorev1.SecretHandlerFunc
		}
...
func (mock *SecretControllerMock) AddClusterScopedFeatureHandler(ctx context.Context, enabled func() bool, name string, clusterName string, handler bhojpurcorev1.SecretHandlerFunc) {
...
func (mock *SecretControllerMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, handler bhojpurcorev1.SecretHandlerFunc) {
...
func (mock *SecretControllerMock) AddFeatureHandler(ctx context.Context, enabled func() bool, name string, syncMoqParam bhojpurcorev1.SecretHandlerFunc) {
...
func (mock *SecretControllerMock) AddHandler(ctx context.Context, name string, handler bhojpurcorev1.SecretHandlerFunc) {
...
func (mock *SecretControllerMock) Lister() bhojpurcorev1.SecretLister {
...
// Ensure, that SecretInterfaceMock does implement bhojpurcorev1.SecretInterface.
// If this is not the case, regenerate this file with moq.
var _ bhojpurcorev1.SecretInterface = &SecretInterfaceMock{}

// SecretInterfaceMock is a mock implementation of bhojpurcorev1.SecretInterface.
//
// 	func TestSomethingThatUsesSecretInterface(t *testing.T) {
//
// 		// make and configure a mocked bhojpurcorev1.SecretInterface
// 		mockedSecretInterface := &SecretInterfaceMock{
// 			AddClusterScopedFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, clusterName string, syncMoqParam bhojpurcorev1.SecretHandlerFunc)  {
// 				panic("mock out the AddClusterScopedFeatureHandler method")
// 			},
// 			AddClusterScopedFeatureLifecycleFunc: func(ctx context.Context, enabled func() bool, name string, clusterName string, lifecycle bhojpurcorev1.SecretLifecycle)  {
// 				panic("mock out the AddClusterScopedFeatureLifecycle method")
// 			},
// 			AddClusterScopedHandlerFunc: func(ctx context.Context, name string, clusterName string, syncMoqParam bhojpurcorev1.SecretHandlerFunc)  {
// 				panic("mock out the AddClusterScopedHandler method")
// 			},
// 			AddClusterScopedLifecycleFunc: func(ctx context.Context, name string, clusterName string, lifecycle bhojpurcorev1.SecretLifecycle)  {
// 				panic("mock out the AddClusterScopedLifecycle method")
// 			},
// 			AddFeatureHandlerFunc: func(ctx context.Context, enabled func() bool, name string, syncMoqParam bhojpurcorev1.SecretHandlerFunc)  {
// 				panic("mock out the AddFeatureHandler method")
// 			},
// 			AddFeatureLifecycleFunc: func(ctx context.Context, enabled func() bool, name string, lifecycle bhojpurcorev1.SecretLifecycle)  {
// 				panic("mock out the AddFeatureLifecycle method")
// 			},
// 			AddHandlerFunc: func(ctx context.Context, name string, syncMoqParam bhojpurcorev1.SecretHandlerFunc)  {
// 				panic("mock out the AddHandler method")
// 			},
// 			AddLifecycleFunc: func(ctx context.Context, name string, lifecycle bhojpurcorev1.SecretLifecycle)  {
// 				panic("mock out the AddLifecycle method")
// 			},
// 			ControllerFunc: func() bhojpurcorev1.SecretController {
...
// 		}
//
// 		// use mockedSecretInterface in code that requires bhojpurcorev1.SecretInterface
// 		// and then make assertions.
//
// 	}
type SecretInterfaceMock struct {
	...
	calls struct {
		...
		AddClusterScopedFeatureLifecycle []struct {
			...
			Lifecycle bhojpurcorev1.SecretLifecycle
		}
		// AddClusterScopedHandler holds details about calls to the AddClusterScopedHandler method.
		AddClusterScopedHandler []struct {
			// Ctx is the ctx argument value.
...
// AddClusterScopedFeatureHandler calls AddClusterScopedFeatureHandlerFunc.
func (mock *SecretInterfaceMock) AddClusterScopedFeatureHandler(ctx context.Context, enabled func() bool, name string, clusterName string, syncMoqParam bhojpurcorev1.SecretHandlerFunc) {
	if mock.AddClusterScopedFeatureHandlerFunc == nil {
...
func (mock *SecretInterfaceMock) AddClusterScopedFeatureLifecycle(ctx context.Context, enabled func() bool, name string, clusterName string, lifecycle bhojpurcorev1.SecretLifecycle) {
...
// AddClusterScopedHandler calls AddClusterScopedHandlerFunc.
func (mock *SecretInterfaceMock) AddClusterScopedHandler(ctx context.Context, name string, clusterName string, syncMoqParam bhojpurcorev1.SecretHandlerFunc) {
	if mock.AddClusterScopedHandlerFunc == nil {
...
func (mock *SecretInterfaceMock) AddClusterScopedLifecycle(ctx context.Context, name string, clusterName string, lifecycle bhojpurcorev1.SecretLifecycle) {
...
// AddFeatureHandler calls AddFeatureHandlerFunc.
func (mock *SecretInterfaceMock) AddFeatureHandler(ctx context.Context, enabled func() bool, name string, syncMoqParam bhojpurcorev1.SecretHandlerFunc) {
	if mock.AddFeatureHandlerFunc == nil {
...
func (mock *SecretInterfaceMock) AddFeatureLifecycle(ctx context.Context, enabled func() bool, name string, lifecycle bhojpurcorev1.SecretLifecycle) {
...
// AddHandler calls AddHandlerFunc.
func (mock *SecretInterfaceMock) AddHandler(ctx context.Context, name string, syncMoqParam bhojpurcorev1.SecretHandlerFunc) {
	if mock.AddHandlerFunc == nil {
...
func (mock *SecretInterfaceMock) AddLifecycle(ctx context.Context, name string, lifecycle bhojpurcorev1.SecretLifecycle) {
...
func (mock *SecretInterfaceMock) Controller() bhojpurcorev1.SecretController {
...
// Ensure, that SecretsGetterMock does implement bhojpurcorev1.SecretsGetter.
// If this is not the case, regenerate this file with moq.
var _ bhojpurcorev1.SecretsGetter = &SecretsGetterMock{}

// SecretsGetterMock is a mock implementation of bhojpurcorev1.SecretsGetter.
//
// 	func TestSomethingThatUsesSecretsGetter(t *testing.T) {
//
// 		// make and configure a mocked bhojpurcorev1.SecretsGetter
// 		mockedSecretsGetter := &SecretsGetterMock{
// 			SecretsFunc: func(namespace string) bhojpurcorev1.SecretInterface {
// 				panic("mock out the Secrets method")
// 			},
// 		}
//
// 		// use mockedSecretsGetter in code that requires bhojpurcorev1.SecretsGetter
// 		// and then make assertions.
//
// 	}
...
func (mock *SecretsGetterMock) Secrets(namespace string) bhojpurcorev1.SecretInterface {
